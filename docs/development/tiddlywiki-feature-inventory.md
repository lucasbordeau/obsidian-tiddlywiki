...
[`tiddlywikiFeatures.test.ts`](../../src/tests/tiddlywikiFeatures.test.ts).
Its 234 cases include 78 native syntax cases, 146 source-preservation cases and ten
...
- **Static**: supported shared semantics use a small, parsed HTML/widget subset
  ...
  [`tiddlywikiCore.test.ts`](../../src/tests/tiddlywikiCore.test.ts) and
  [`conversionEngine.test.ts`](../../src/tests/conversionEngine.test.ts).
...
[metadata and media coverage](metadata-media-feature-inventory.md).
