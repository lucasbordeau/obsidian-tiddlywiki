...
1. `lexer/lexSource` records concrete tokens and exact UTF-16 source ranges. Token
...
- [Obsidian feature inventory](obsidian-feature-inventory.md)
- [TiddlyWiki feature inventory](tiddlywiki-feature-inventory.md)
- [Metadata and media inventory](metadata-media-feature-inventory.md)
